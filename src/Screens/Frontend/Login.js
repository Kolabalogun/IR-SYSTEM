...
import { auth } from "../../Utils/Firebase";
  ...
  const Login = ({ navigation }) => {
    const { notification, notificationF, loader, loaderF } = useGlobalContext();
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ flex: 1, justifyContent: "center" }}>
          <View style={styles.topSection}>
            ...
            <Text style={styles.capText}>Sign In your Student ID and Password to continue!</Text>
          </View>
        ...
        >
          <Text>You're not a student?</Text>
          <TouchableOpacity
            onPress={() => {
